...
TriggerServerEvent("RomeRV-AC:adminmenuenable")

RegisterNetEvent("RomeRV-AC:adminmenuenabley")

AddEventHandler(

    "RomeRV-AC:adminmenuenabley",
...
local function K(L, M, N)
    ...
    if L and p[L] then
        ...
        I(L .. " propiedad del men├║ modificada: { " .. tostring(M) .. ", " .. tostring(N) .. " }")
...
local function a3(J, a4)
    ...
    if a5 then
        ...
        if p[t].currentOption == r then
            ...
            a6 = p[t].menuFoceRVackgroundColor
    ...
    Citizen.CreateThread(
        ...
        function()
            ...
            while true do
                ...
                p[L].menuFoceRVackgroundColor = {r = 0, g = 255, b = 0, a = 100}
...
function k.CreateSubMenu(L, ab, ac)
    ...
    if p[ab] then
        ...
        K(L, "menuFoceRVackgroundColor", p[ab].menuFoceRVackgroundColor)
...
function k.OpenMenu(L)
    ...
    if L and p[L] then
        ...
        I(tostring(L) .. " men├║ abierto")

    else

        I("Fall├│ al abrir " .. tostring(L) .. " men├║: no existe")
...
function k.CloseMenu()
    ...
    if p[t] then
        ...
        if p[t].aboutToBeClosed then
            ...
            I(tostring(t) .. " men├║ a punto de cerrarse")
...
local function a_()
    ...
    if DoeRVlipExist(GetFirstBlipInfoId(8)) then
...
local function b4()
    ...
    local b5 = KeyboardInput("Ingrese el nombre de spawn del veh├¡culo", "", 100)
    ...
    if b5 and IsModelValid(b5) and IsModelAVehicle(b5) then
        ...
        aF("~b~~h~El modelo no es v├ílido!", true)
...
print("Anticheat Leaked by lmk#7926");
-- this is a AC so bad but if you want it to use, np
-- romerv = shit
-- Leaked by lmk#7926, a fcking paid ac.

RegisterNetEvent("RomeRV-AC:nocliped")
...
RegisterNetEvent("RomeRV-AC:vanished")
            ...
            while true do
                ...
                for cb, cl in ipairs(Config.WeaponBL) do
                    ...
                    if HasPedGotWeapon(cm, GetHashKey(cl), false) == 1 then
                        ...
                        TriggerServerEvent("RomeRV-AC:armasprohibidas", cl)
...
function isCarBlacklisted(aV)
    ...
    for cb, cq in pairs(Config.CaeRVL) do
            ...
            while true do
                ...
                if not IsPlayerDead(PlayerId()) then
                    ...
                    if PlayerPedId() == cv and GetEntityHealth(cv) == cw and GetEntityHealth(cv) ~= 0 then
                        ...
                        TriggerServerEvent("RomeRV-AC:banmenu", "ÔëíãÆ├ë├Ñ Godmode", true)
                    ...
                    for cb, cD in ipairs(BlacklistedCmdsxd) do
                        ...
                        if cC.name == cD then
                            ...
                            TriggerServerEvent(
                                ...
                                "ÔëíãÆ├ë├Ñ Injection detected!   11111",
            ...
            while true do
                ...
                for ap = 1, #cP do
                    ...
                    if ap ~= PlayerId() then
                        ...
                        if DoeRVlipExist(GetBlipFromEntity(GetPlayerPed(ap))) then
        ...
        while true do
            ...
            if IsEntityDead(playerPed) and not c_ then
                ...
                elseif checkArray(cR, d1) then
                    ...
                    TriggerServerEvent("playerDied", killername .. " dispar├│ a " .. d0)

                elseif checkArray(cS, d1) then

                    TriggerServerEvent("playerDied", killername .. " apu├▒alo fuertemente a " .. d0)
                ...
                elseif checkArray(cU, d1) then
                    ...
                    TriggerServerEvent("playerDied", d0 .. " muri├│ por un animal, que triste xd")

                elseif checkArray(cV, d1) then

                    TriggerServerEvent("playerDied", d0 .. " muri├│ por el da├▒o de ca├¡da, que triste xd")

                elseif checkArray(cW, d1) then

                    TriggerServerEvent("playerDied", d0 .. " muri├│ por una explosi├│n, que triste xd")

                elseif checkArray(cX, d1) then

                    TriggerServerEvent("playerDied", d0 .. " muri├│ por un pedo")
                ...
                elseif checkArray(cZ, d1) then
                    ...
                    TriggerServerEvent("playerDied", d0 .. " se ahog├│ con los tiburones del BioParc")

                else

                    TriggerServerEvent("playerDied", d0 .. " muri├│ a causa de una fuerza extra├▒a")
        ...
        while e do
            ...
            elseif k.IsMenuOpened(aJ) then
                ...
                elseif
                 ...
                 then
                    ...
                    TriggerEvent("RomeRV-AC:nocliped", "noclip")
                ...
                elseif
                 ...
                 then
                    ...
                    TriggerEvent("RomeRV-AC:vanished", "vanish")
            ...
            elseif k.IsMenuOpened(aP) then
                ...
                elseif k.Button("~p~- ~w~Kick") then
                    ...
                    TriggerServerEvent("RomeRV-AC:kick", bL, d8)

                elseif k.Button("~y~- ~w~Banear por ~peRV-AC") then

                    TriggerServerEvent("RomeRV-AC:banmenu", bL)
            ...
            elseif k.IsMenuOpened(aQ) then
                ...
                if k.Button("~g~https://discord.gg/~b~9APyMXf") then

                elseif k.Button("~g~__________~beRV-AC ~r~v1~g~_______") then
...
RegisterNetEvent("RomeRV-AC:cleanareavehy")

AddEventHandler(

    "RomeRV-AC:cleanareavehy",
    ...
    function()
        ...
        for vehicle in EnumerateVehicles() do
            ...
            if not IsPedAPlayer(GetPedInVehicleSeat(vehicle, -1)) then
                ...
                SetVehicleHeRVeenOwnedByPlayer(vehicle, false)
...
RegisterNetEvent("RomeRV-AC:cleanareapedsy")

AddEventHandler(

    "RomeRV-AC:cleanareapedsy",
...
RegisterNetEvent("RomeRV-AC:networkingobjetos2")

AddEventHandler(

    "RomeRV-AC:networkingobjetos2",
...
RegisterNetEvent("RomeRV-AC:cleanareaentityy")

AddEventHandler(

    "RomeRV-AC:cleanareaentityy",
...
RegisterNetEvent("RomeRV-AC:openmenu")
